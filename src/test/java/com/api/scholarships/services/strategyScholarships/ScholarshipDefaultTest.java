...
@ActiveProfiles("test")
class ScholarshipDefaultTest {
  @Mock
  private ScholarshipRepository scholarshipRepository;
  @InjectMocks
  private ScholarshipDefault scholarshipDefault;
  ...
  @Test
  @DisplayName("Test ScholarshipDefault, test to find all scholarships without any condition ")
  void   testScholarshipStatus(){
    //given
    ...
    given(scholarshipRepository.findAll(pageable)).willReturn(scholarships);
    //when
    Page<Scholarship> scholarshipsFound=scholarshipDefault.findScholarshipsByCondition(pageable,1L);
    //then
    assertAll(
